...
import { AppBarContainer, AppBarSection, MenuButton, ToggleSidebarButton, Logo, Avatar, AvatarImage } from './AppBar.styles';
...
export const AppBar = ({ onMenuClick, onToggleSidebar, userName, isSidebarCollapsed = false }: AppBarProps) => {
    return (
