...
const PeriodButton = styled(Button)<{ isSelected: boolean }>`
   ...
   &:hover::after {
      background-color: ${({ isSelected }) =>
         isSelected ? 'var(--primary)' : 'var(--primary-hover)'};
      display: block;
      transform: scale(1);
   }
`;

export const PaymentPeriodSelector = ({
   selectedPeriod,
   onPeriodChange,
      ...
      <SelectorContainer>
         ...
         >
            <div className="text-container">
               <Typography
                  weight={selectedPeriod === 'daily' ? 'semibold' : 'regular'}
         ...
         >
            <div className="text-container">
               <Typography
                  weight={selectedPeriod === 'weekly' ? 'semibold' : 'regular'}
                  color={'var(--dark-hover)'}
               >
                  Semanal
               </Typography>
         ...
         >
            <div className="text-container">
               <Typography
                  weight={selectedPeriod === 'monthly' ? 'semibold' : 'regular'}
                  color={'var(--dark-hover)'}
               >
                  Mensual
               </Typography>
